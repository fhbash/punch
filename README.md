...
```
_By default this will install the `my-custom-holiday.yml` into
...
**NOTE**  
_By default the holiday file will be installed in the `RP_INSTALL_DIR` which
default points to "$HOME/bin"._    
